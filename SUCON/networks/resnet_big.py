...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, in_channel=6, zero_init_residual=False):
        ...
        self.conv1 = nn.Conv2d(in_channel, 64, kernel_size=3, stride=1, padding=2,
                               bias=False)
